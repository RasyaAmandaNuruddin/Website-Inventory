            ...
            <div id="layoutSidenav_content">
                ...
                <?php endif; ?>
                        <div class="card mb-4">
                            ...
                            <button type="button" class="btn btn-success" onclick="window.location.href='exportmasuk.php'">
                                Ekspor Data
                            </button>
                            <br>
                            <div class="row mt-4">
                                ...
                                <thead>
                                    ...
                                    if (isset($_POST['filtertanggal'])) {
                                        ...
                                        if (!empty($mulai) && !empty($selesai)) {
                                            $ambilsemuadatastok  = mysqli_query($conn, "SELECT * FROM masuk m, stok s WHERE s.idbarang = m.idbarang AND m.tanggal BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY) ORDER BY m.idmasuk DESC");
                                        } else {
                                            // Jika tidak ada tanggal yang diisi, ambil semua data
                                            $ambilsemuadatastok  = mysqli_query($conn, "SELECT * FROM masuk m, stok s WHERE s.idbarang = m.idbarang ORDER BY m.idmasuk DESC");
                                        }
                                    } else {
                                        // Jika tombol filter tidak ditekan, ambil semua data
                                        $ambilsemuadatastok = mysqli_query($conn, "SELECT * FROM masuk m, stok s WHERE s.idbarang = m.idbarang ORDER BY m.idmasuk DESC");
                                    }
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <select name="barangnya" class="form-control">
        ...
        <input type="text" name="penerima" placeholder="keterangan barang" class="form-control" required><br>
